...
\begin{table}[H]
  ...
  \begin{tabular}{llp{8.5cm}}
    \toprule
    \textbf{Parameter} & \textbf{Typ} & \textbf{Bedeutung} \\ \midrule
    \texttt{gate\_dist\_max} & [m] & euklidische Obergrenze des Gates (z.\,B. 3\,--\,4\,m) \\
    \texttt{min\_hits} & [Frame] & Bestätigungsschwelle (2\,--\,3) \\
    \texttt{max\_missed} & [Frame] & Löschschwelle ohne Zuordnung (6\,--\,10) \\
    \texttt{max\_size\_L,W,H} & [m] & Plausibilitätsobergrenzen (z.\,B. L\,\(\leq\,8\), W\,\(\leq\,5\), H\,\(\leq\,4.2\)) \\ \bottomrule
  \end{tabular}
...
\begin{table}[H]
  ...
  \begin{tabular}{lccc}
    \toprule
    \textbf{Objektklasse} & \textbf{Länge [m]} & \textbf{Breite [m]} & \textbf{Höhe [m]} \\ \midrule
    Mensch         & 0.3 -- 1.6  & 0.4 -- 1.0  & 1.0 -- 2.0 \\
    Fahrradfahrer  & 0.6 -- 2.0  & 0.6 -- 1.5  & 0.4 -- 1.6 \\
    Pkw            & 2.0 -- 4.5  & 1.4 -- 3.0  & 0.6 -- 2.1 \\
    Lkw            & 4.5 -- 8.0  & 2.0 -- 5.0  & 2.0 -- 4.2 \\ \bottomrule
  \end{tabular}
