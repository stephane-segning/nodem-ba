...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\linewidth]{images/aabb_obb_vs.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{images/aabb_obb_compare.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.4\textwidth]{images/clustering_result.png}
